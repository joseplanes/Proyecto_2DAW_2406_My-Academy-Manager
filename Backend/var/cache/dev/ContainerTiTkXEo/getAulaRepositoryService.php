 ...
 */
class getAulaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AulaRepository' shared autowired service.
     *
     * @return \App\Repository\AulaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AulaRepository.php';

        return $container->privates['App\\Repository\\AulaRepository'] = new \App\Repository\AulaRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
