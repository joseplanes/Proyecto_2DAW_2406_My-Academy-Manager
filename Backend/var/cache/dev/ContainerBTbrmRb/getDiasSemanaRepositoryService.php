 ...
 */
class getDiasSemanaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DiasSemanaRepository' shared autowired service.
     *
     * @return \App\Repository\DiasSemanaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DiasSemanaRepository.php';

        return $container->privates['App\\Repository\\DiasSemanaRepository'] = new \App\Repository\DiasSemanaRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
