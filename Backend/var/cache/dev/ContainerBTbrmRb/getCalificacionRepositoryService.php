 ...
 */
class getCalificacionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CalificacionRepository' shared autowired service.
     *
     * @return \App\Repository\CalificacionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CalificacionRepository.php';

        return $container->privates['App\\Repository\\CalificacionRepository'] = new \App\Repository\CalificacionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
