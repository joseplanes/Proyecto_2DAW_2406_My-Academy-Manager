 ...
 */
class getAsignaturaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AsignaturaRepository' shared autowired service.
     *
     * @return \App\Repository\AsignaturaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AsignaturaRepository.php';

        return $container->privates['App\\Repository\\AsignaturaRepository'] = new \App\Repository\AsignaturaRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
