 ...
 */
class getClaseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ClaseRepository' shared autowired service.
     *
     * @return \App\Repository\ClaseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ClaseRepository.php';

        return $container->privates['App\\Repository\\ClaseRepository'] = new \App\Repository\ClaseRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
